/**
 * Export Options Editor Plugin - Advanced Export Configuration for CE.SDK
 *
 * This plugin provides a production-ready editor configuration with advanced
 * export options including format selection, quality settings, resolution control,
 * and page range selection for multi-page documents.
 *
 * @example Basic usage
 * ```typescript
 * import CreativeEditorSDK from '@cesdk/cesdk-js';
 * import { ExportOptionsEditorConfig } from './plugin';
 *
...
/**
 * Export Options Editor configuration plugin.
 *
 * Provides a complete editing experience with advanced export capabilities
 * including format selection (JPEG, PNG, PDF), quality and resolution settings,
 * and page range selection for multi-page designs.
 *
 * @public
 */
export class ExportOptionsEditorConfig implements EditorPlugin {
  /**
   * Unique identifier for this plugin.
   * Used to identify the plugin in the CE.SDK plugin registry.
   */
  name = 'cesdk-export-options-editor';
